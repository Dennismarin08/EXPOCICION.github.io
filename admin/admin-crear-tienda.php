...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $pdo->commit();
        $mensaje = "Tienda creada correctamente. ID Usuario: $userId";
...
<head>
    ...
    <title>Crear Tienda - Admin RUGAL</title>
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-left">
                <h1 class="page-title">Crear Nueva Tienda</h1>
        ...
        <div class="content-wrapper">
            <div class="card" style="max-width: 800px; margin: 0 auto;">
                <div class="card-header">
                    <h3>Datos de la Tienda Pet Shop</h3>
                </div>
                ...
                <div class="welcome-content" style="padding: 30px; color: var(--text-primary);">
                    ...
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <h4 style="margin-bottom:15px; color:var(--admin-accent);">Información Comercial</h4>
                                <div style="margin-bottom: 15px;">
                                    <label style="display:block; margin-bottom:5px; font-weight:600;">Nombre de la Tienda *</label>
                                    <input type="text" name="nombre_local" required style="width:100%; padding:10px; border:1px solid #e2e8f0; border-radius:8px;">
                                </div>
                                <div style="margin-bottom: 15px;">
                                    <label style="display:block; margin-bottom:5px; font-weight:600;">Dirección / Ubicación</label>
                                    <input type="text" name="direccion" style="width:100%; padding:10px; border:1px solid #e2e8f0; border-radius:8px;">
                                </div>
                                <div style="margin-bottom: 15px;">
                                    <label style="display:block; margin-bottom:5px; font-weight:600;">Descripción del Negocio</label>
                        ...
                        <div style="text-align:right; margin-top:20px;">
                            <button type="submit" class="btn-create" style="padding:15px 30px; font-size:16px; background:#f59e0b !important;">
                                <i class="fas fa-store"></i> Registrar Tienda
                            </button>
                        </div>
                    </form>
                </div>
