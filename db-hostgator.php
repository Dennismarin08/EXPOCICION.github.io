<?php
// db-hostgator.php - CONFIGURACIÓN PARA HOSTGATOR (PRODUCCIÓN)
// Para usar: Renombrar este archivo a 'db.php' antes de subirlo a HostGator.
...
class Database {
    ...
    private function __construct() {
        try {
            // Configuración HOSTGATOR (Producción)
            $host = 'localhost';
            $dbname = 'edgarga5_rugal_db'; 
            $username = 'edgarga5_rugal_user'; // Usuario corregido según tu reporte
            $password = 'Dennis0824';          // Contraseña corregida según tu reporte
